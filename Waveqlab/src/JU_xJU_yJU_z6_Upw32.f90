...
!!$    if ((px == nx) .and. (F%PMLB(2)%pml .EQV. .TRUE.)) fx = px - max(F%PMLB(2)%N_pml, 6)
  ...
  subroutine JJU_x6_interior_upwind(F, G, M, type_of_mesh)
    ...
    real(kind = wp),parameter :: cf(1:4) = (/ -1.0_wp/3.0_wp, -0.5_wp, 1.0_wp, -1.0_wp/6.0_wp /) ! forward  FD coefficients 
    real(kind = wp),parameter :: cb(1:4) = (/ 1.0_wp/6.0_wp, -1.0_wp, 0.5_wp, 1.0_wp/3.0_wp  /) ! backward FD coefficients 
...
!!$    if ((px == nx) .and. (F%PMLB(2)%pml .EQV. .TRUE.)) fx = px - max(F%PMLB(2)%N_pml, 6)
  ...
  subroutine JJU_x6_upwind(x, y, z, F, G, X_x, Ju_x)
     ...
     if ((x .ge. 3) .and. (x .le. nx-2)) then
        ...
        Jq_xU(1:3) = X_x(x, y, z, 1)*(-1.0_wp/3.0_wp*F%F(x-1, y, z, 1:3)&
             - 0.5_wp*F%F(x, y, z, 1:3)&
             + 1.0_wp*F%F(x+1, y, z, 1:3)&
             - 1.0_wp/6.0_wp*F%F(x+2, y, z, 1:3)) 


       ! backward FD 

        Jq_xU(4:9) = X_x(x, y, z, 1) * (1.0_wp/6.0_wp*F%F(x-2, y, z, 4:n)&
              - 1.0_wp*F%F(x-1, y, z, 4:n)&
              + 0.5_wp*F%F(x, y, z, 4:n) &
              + 1.0_wp/3.0_wp*F%F(x+1, y, z, 4:n))
     ...
     if (x .eq. 1) then
        ...
        Jq_xU(1:3) = X_x(x, y, z, 1)*(- 1.4_wp*F%F(1, y, z, 1:3) + 1.8_wp*F%F(2, y, z, 1:3) - 0.4_wp*F%F(3, y, z, 1:3)) 


        ! Use backward FD for velocity fields
        Jq_xU(4:9) =  X_x(x, y, z, 1)*(-1.0_wp*F%F(1, y, z, 4:n) + 1.0_wp*F%F(2, y, z, 4:n))
     ...
     if (x .eq. 2) then
        ...
        ! Use forward FD for velocity fields
        Jq_xU(1:3) = X_x(x, y, z, 1)*(-0.3846153846153846_wp*F%F(1, y, z, 1:3) &
             - 0.3846153846153846_wp*F%F(2, y, z, 1:3) &
             + 0.9230769230769231_wp*F%F(3, y, z, 1:3) &
             - 0.1538461538461539_wp*F%F(4, y, z, 1:3))
     
        Jq_xU(4:9) = X_x(x, y, z, 1)*(-0.6923076923076923_wp*F%F(1, y, z, 4:n) &
             + 0.3846153846153846_wp*F%F(2, y, z, 4:n) &
             + 0.3076923076923077_wp*F%F(3, y, z, 4:n))
     ...
     if (x .eq. nx-1) then
        ...
        Jq_xU(1:3) = X_x(x, y, z, 1)*(-0.3076923076923077_wp*F%F(nx-2, y, z, 1:3)&
             - 0.3846153846153846_wp*F%F(nx-1, y, z, 1:3)&
             + 0.6923076923076923_wp*F%F(nx,   y, z, 1:3)) 


         ! Backward FD for stress fields
        Jq_xU(4:9) = X_x(x, y, z, 1)*(0.1538461538461539_wp*F%F(nx-3, y, z, 4:n) &
             - 0.9230769230769231_wp*F%F(nx-2, y, z, 4:n)&
             + 0.3846153846153846_wp*F%F(nx-1, y, z, 4:n)&
             + 0.3846153846153846_wp*F%F(nx,   y, z, 4:n))
     ...
     if (x .eq. nx) then
        ...
        Jq_xU(1:3) = X_x(x, y, z, 1)*(-1.0_wp*F%F(nx-1, y, z, 1:3) +  1.0_wp*F%F(nx, y, z, 1:3))



        ! Backward FD for stress fields
         Jq_xU(4:9) = X_x(x, y, z, 1)*(0.4_wp*F%F(nx-2, y, z, 4:n) - 1.8_wp*F%F(nx-1, y, z, 4:n) + 1.4_wp*F%F(nx, y, z, 4:n))
     ...
     if ((y .ge. 3) .and. (y .le. ny-2)) then
          ! forward FD
          Jr_xU(1:3) = X_x(x, y, z, 1)*(-1.0_wp/3.0_wp*F%F(x, y-1, z, 1:3)&
               - 0.5_wp*F%F(x, y, z, 1:3)&
               + 1.0_wp*F%F(x, y+1, z, 1:3)&
               - 1.0_wp/6.0_wp*F%F(x, y+2, z, 1:3)) 
  
  
         ! backward FD 
  
          Jr_xU(4:9) = X_x(x, y, z, 1) * (1.0_wp/6.0_wp*F%F(x, y-2, z, 4:n)&
                - 1.0_wp*F%F(x, y-1, z, 4:n)&
                + 0.5_wp*F%F(x, y, z, 4:n) &
                + 1.0_wp/3.0_wp*F%F(x, y+1, z, 4:n))
       ...
       if (y .eq. 1) then
          ...
          ! Use forward FD for velocity fields
          Jr_xU(1:3) = X_x(x, y, z, 2)*(- 1.4_wp*F%F(x, 1, z, 1:3) + 1.8_wp*F%F(x, 2, z, 1:3) - 0.4_wp*F%F(x, 3, z, 1:3)) 
  
  
          ! Use backward FD for velocity fields
          Jr_xU(4:9) =  X_x(x, y, z, 2)*(-1.0_wp*F%F(x, 1, z, 4:n) + 1.0_wp*F%F(x, 2, z, 4:n))
       ...
       if (y .eq. 2) then
          ...
          ! Use forward FD for velocity fields
          Jr_xU(1:3) = X_x(x, y, z, 2)*(-0.3846153846153846_wp*F%F(x, 1, z, 1:3) &
               - 0.3846153846153846_wp*F%F(x, 2, z, 1:3) &
               + 0.9230769230769231_wp*F%F(x, 3, z, 1:3) &
               - 0.1538461538461539_wp*F%F(x, 4, z, 1:3))
       
          Jr_xU(4:9) = X_x(x, y, z, 2)*(-0.6923076923076923_wp*F%F(x, 1, z, 4:n) &
               + 0.3846153846153846_wp*F%F(x, 2, z, 4:n) &
               + 0.3076923076923077_wp*F%F(x, 3, z, 4:n))
       ...
       if (y .eq. nx-1) then
           ...
           ! Forward FD for velocity fields
          Jr_xU(1:3) = X_x(x, y, z, 2)*(-0.3076923076923077_wp*F%F(x, ny-2, z, 1:3)&
               - 0.3846153846153846_wp*F%F(x, ny-1, z, 1:3)&
               + 0.6923076923076923_wp*F%F(x, ny, z, 1:3)) 
  
  
           ! Backward FD for stress fields
          Jr_xU(4:9) = X_x(x, y, z, 2)*(0.1538461538461539_wp*F%F(x, ny-3, z, 4:n) &
               - 0.9230769230769231_wp*F%F(x, ny-2, z, 4:n)&
               + 0.3846153846153846_wp*F%F(x, ny-1, z, 4:n)&
               + 0.3846153846153846_wp*F%F(x, ny,   z, 4:n))
       ...
       if (y .eq. ny) then
          ...
          Jr_xU(1:3) = X_x(x, y, z, 2)*(-1.0_wp*F%F(x, ny-1, z, 1:3) +  1.0_wp*F%F(x, ny, z, 1:3))
  
  
  
          ! Backward FD for stress fields
          Jr_xU(4:9) = X_x(x, y, z, 2)*(0.4_wp*F%F(x, ny-2, z, 4:n) -1.8_wp*F%F(x, ny-1, z, 4:n) +1.4_wp*F%F(x, ny, z, 4:n))
     ...
     if ((z .ge. 3) .and. (z .le. nz-2)) then
          ! forward FD
          Js_xU(1:3) = X_x(x, y, z, 3)*(-1.0_wp/3.0_wp*F%F(x, y, z-1, 1:3)&
               - 0.5_wp*F%F(x, y, z, 1:3)&
               + 1.0_wp*F%F(x, y, z+1, 1:3)&
               - 1.0_wp/6.0_wp*F%F(x, y, z+2, 1:3)) 
  
  
         ! backward FD 
  
          Js_xU(4:9) = X_x(x, y, z, 3) * (1.0_wp/6.0_wp*F%F(x, y, z-2, 4:n)&
                - 1.0_wp*F%F(x, y, z-1, 4:n)&
                + 0.5_wp*F%F(x, y, z, 4:n) &
                + 1.0_wp/3.0_wp*F%F(x, y, z+1, 4:n))
       ...
       if (z .eq. 1) then
          ...
          ! Use forward FD for velocity fields
          Js_xU(1:3) = X_x(x, y, z, 3)*(- 1.4_wp*F%F(x, y, 1, 1:3) + 1.8_wp*F%F(x, y, 2, 1:3) - 0.4_wp*F%F(x, y, 3, 1:3)) 
  
  
          ! Use backward FD for velocity fields
          Js_xU(4:9) =  X_x(x, y, z, 3)*(-1.0_wp*F%F(x, y, 1, 4:n) + 1.0_wp*F%F(x, y, 2, 4:n))
       ...
       if (z .eq. 2) then
          ...
          ! Use forward FD for velocity fields
          Js_xU(1:3) = X_x(x, y, z, 3)*(-0.3846153846153846_wp*F%F(x, y, 1, 1:3) &
               - 0.3846153846153846_wp*F%F(x, y, 2, 1:3) &
               + 0.9230769230769231_wp*F%F(x, y, 3, 1:3) &
               - 0.1538461538461539_wp*F%F(x, y, 4, 1:3))
       
          Js_xU(4:9) = X_x(x, y, z, 3)*(-0.6923076923076923_wp*F%F(x, y, 1, 4:n) &
               + 0.3846153846153846_wp*F%F(x, y, 2, 4:n) &
               + 0.3076923076923077_wp*F%F(x, y, 3, 4:n))
       ...
       if (z .eq. nz-1) then
           ...
           ! Forward FD for velocity fields
          Js_xU(1:3) = X_x(x, y, z, 3)*(-0.3076923076923077_wp*F%F(x, y, nz-2, 1:3)&
               - 0.3846153846153846_wp*F%F(x, y, nz-1, 1:3)&
               + 0.6923076923076923_wp*F%F(x, y, nz,   1:3)) 
  
  
           ! Backward FD for stress fields
          Js_xU(4:9) = X_x(x, y, z, 3)*(0.1538461538461539_wp*F%F(x, y, nz-3, 4:n) &
               - 0.9230769230769231_wp*F%F(x, y, nz-2, 4:n)&
               + 0.3846153846153846_wp*F%F(x, y, nz-1, 4:n)&
               + 0.3846153846153846_wp*F%F(x, y, nz,   4:n))
       ...
       if (z .eq. nz) then
          ...
          Js_xU(1:3) = X_x(x, y, z, 3)*(-1.0_wp*F%F(x, y, nz-1, 1:3) +  1.0_wp*F%F(x, y, nz, 1:3))
  
  
  
          ! Backward FD for stress fields
           Js_xU(4:9) = X_x(x, y, z, 3)*(0.4_wp*F%F(x, y, nz-2, 4:n) -1.8_wp*F%F(x, y, nz-1, 4:n) +1.4_wp*F%F(x, y, nz, 4:n))
